<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-light" style = "background-color:rgba(0,0,0,1);">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
   ...
   <!-- Right navbar links -->
    ...
    <li><a href="logout.php" class=" btn text-center" style="color:white"><i class="fa fa-sign-out"></i> Logout</a></li>
    </ul>
