...
<html lang="en">
  ...
  <body>
    <form action="../index.php" class="form">
      <h1 class="text-center">Transfer Entry Requirements</h1>
      <!-- Progress bar -->
      ...
      <div class="form-step form-step-active" id="tab-1">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <label for="">Previous Level</label><span class = "star"> *</span>
                <select name="" class="form-control" id="level" required>
                    <option value="" selected>--Please choose an option--</option>
      ...
      <div class="form-step" id="tab-2">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <label for="">Upload Admission Letter</label><span class = "star"> *</span>
              <input type="file" id="myfile" name="myfile" accept="image/*" required>
              <small><h6 class="mt-1 text-danger">please upload a valid and clear Image file.</h6></small>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <label for="">Upload Transcript</label><span class = "star"> *</span>
          ...
          <div class="row">
            <div class="col-sm-6">
              <label for="">Upload Last/Recent Result</label>
              <input type="file" id="myfile" name="myfile" accept="image/*">
              <small><h6 class="mt-1 text-danger">please upload a valid and clear Image file.</h6></small>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-4 mt-2">
              <div class="bt-group">
                <input type="button" value="Previous" class="btn btn-prev w-100 mt-2"> 
              </div>
            </div>
            <div class="col-sm-4">
            </div>
            <div class="col-sm-4 mt-2">
              <div class="">
              <input type="button" value="Next" class="btn btn-next w-100 mt-2"> 
              </div>
            </div>
          </div>
        </div>
