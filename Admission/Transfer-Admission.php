...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../css/Transfer-Admission.css">
    <title>Transfer Admission-IAEC University</title>
</head>
<body>
...
<div class="container" >
    <div class = "row ">
        <div class = "col-sm-12">
         <header>Transfer Entry Requirements</header>
            ...
            <div class="form-outer">
                <form action="#">
                    <div class="page slide-page">
                        ...
                        <div class="field-1">
                            <div class="label-1">
                            Previous Level<span class = "star"> *</span>
                            </div>
                        ...
                        <div class="field-3" id = "div1" style ="display:none">
                            <div class="label-3">
                        ...
                        <div class="field-3" id = "div2" style ="display:none">
                            <div class="label-3">
                            Department<span class = "star"> *</span>
                            </div>
                            <select name="" id="">
                        ...
                        <div class="field-3" id = "div3" style ="display:none">
                            <div class="label-3">
                            Department<span class = "star"> *</span>
                            </div>
                            <select name="" id="">
                        ...
                        <div class="field-3" id = "div4" style ="display:none">
                            <div class="label-3">
                            Department<span class = "star"> *</span>
                            </div>
                            <select name="" id="">
