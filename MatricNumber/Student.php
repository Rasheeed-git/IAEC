      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item active">Student's Bio</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-sm-4">
            <div class="box box-primary pay-box">
              <div class="box-header with-border">
                  <h4 class="box-title heading ml-2">Student Data</h4>
              </div><!-- /.box-header -->
                <div class="box-body pay-body">
                    <div class="form-group" id="">
                      <form role="form" action="Student-Data.php" method="post" id=""> 
                          <label for="" class="heading ml-2">Matric Number</label>
                          <input type="text" class="form-control col-11  ml-2" id="name" placeholder="Enter Admission Number" name="namecomplete="off">
