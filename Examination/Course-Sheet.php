...
<!--/SideBar-->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="Course-Marks-Sheet.php" class = "breadcrumb-link">Course-Marks-Sheet</a></li>
              <li class="breadcrumb-item active">Course-Sheet</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6">
                <label for="">Course: </label> Computer Programming<br>
                <label for="">Course Code: </label> CSC440<br>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title w-100">Course Mark's Sheet</h3>
